...
function make_tables($sex) {
	...
	$recs = array();
	$r = $res[$bt[1]];
	$recs['bt'] = "{$bt[0]} {$r['nazwisko']} {$r['imie']} [{$r['nrZawodnika']}] in {$r['nrPrzejazdu']}. run";
	$r = $res[$brt[1]];
	$recs['brt'] = "{$brt[0]} {$r['nazwisko']} {$r['imie']} [{$r['nrZawodnika']}] in {$r['nrPrzejazdu']}. run";
	$r = $res[$mb[1]];
	$recs['mb'] = "{$mb[0]} {$r['nazwisko']} {$r['imie']} [{$r['nrZawodnika']}] in {$r['nrPrzejazdu']}. run";
