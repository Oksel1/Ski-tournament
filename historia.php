...
<p>Dodatkowe statystyki z zawodów:</p>

	<div id='statystyki-k'>
      <p>Najlepszy czas wśród kobiet: {$rk[1]['brt']}</p>
		<p>Najlepszy czas z bonifikatą wśród kobiet: {$rk[1]['bt']}</p>
      <p>Największa liczba bonusów w przejeździe wśród kobiet: {$rk[1]['mb']} </p>
      <p>Największa liczba zdobytych bonusów wśród kobiet: {$rk[1]['tmb']} </p>
	</div>
	<div id='statystyki-m'>
		<p>Najlepszy czas wśród mężczyzn: {$rm[1]['brt']}</p>
      <p>Najlepszy czas z bonifikata wśród mężczyzn: {$rm[1]['bt']}</p>
		<p>Największa liczba bonusów w przejeździe wśród mężczyzn: {$rm[1]['mb']}</p>
		<p>Największa liczba zdobytych bonusów wśród mężczyzn: {$rm[1]['tmb']}</p>
    </div>
";
